...
-- =====================================================
-- SAMPLE ORDERS (For testing order workflow)
-- =====================================================
INSERT INTO orders (user_id, total_amount, currency_id, status, delivery_address, notes) VALUES
-- Completed order
(3, 18.98, 1, 'DELIVERED', '789 Customer Lane, Burrito Town', 'Please ring doorbell'),

-- Pending order
(4, 12.99, 1, 'PENDING', '321 Hungry Street, Food City', 'Leave at front door');

-- =====================================================
-- ORDER ITEMS (Items in the sample orders)
-- =====================================================
INSERT INTO order_items (order_id, product_id, quantity, unit_price, customizations) VALUES
-- Order 1 items
(1, 1, 2, 8.99, 'Protein: Grilled Chicken; Rice: Cilantro Lime Rice; Beans: Black Beans; Vegetables: Lettuce, Tomatoes; Sauces: Mild Salsa'),

-- Order 2 items
(2, 5, 1, 12.99, 'Protein: Steak; Rice: Cilantro Lime Rice; Beans: Black Beans; Extras: Extra Meat');

-- =====================================================
-- TRANSACTION LOG (Sample payment records)
-- =====================================================
INSERT INTO transaction_log (order_id, payment_status, amount, transaction_reference, processed_at) VALUES
-- Successful payment for order 1
(1, 'COMPLETED', 18.98, 'TXN123ABC456DEF', '2024-01-15 14:30:00'),

-- Pending payment for order 2
(2, 'PENDING', 12.99, 'TXN789GHI012JKL', '2024-01-15 15:45:00');

-- =====================================================
-- SAMPLE CART ITEMS (For testing cart functionality)
-- =====================================================
INSERT INTO cart_items (user_id, product_id, quantity, customizations, customizations_hash) VALUES
-- John's cart
(3, 2, 1, 'Protein: Barbacoa; Rice: Cilantro Lime Rice; Beans: Black Beans; Sauces: Hot Salsa, Guacamole', SHA2('Protein: Barbacoa; Rice: Cilantro Lime Rice; Beans: Black Beans; Sauces: Hot Salsa, Guacamole', 256)),
(3, 6, 1, NULL, SHA2('', 256)),

-- Jane's cart
(4, 3, 1, 'Protein: Sofritas; Rice: Brown Rice; Vegetables: Lettuce, Tomatoes, Corn; Sauces: Guacamole', SHA2('Protein: Sofritas; Rice: Brown Rice; Vegetables: Lettuce, Tomatoes, Corn; Sauces: Guacamole', 256));
